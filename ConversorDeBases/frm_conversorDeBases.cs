                    ...
                    case "Decimal": //base decimal
                        ...
                        switch (rbt_baseFinal.Text) //base desejada para conversão
                        {
                            ...
                            case "Binário": //decimal -> binário
                                ...
                                string resto = "";
                                ltx_resultado.Items.Add($"({quoc}){(char)('₀' + 1)}{(char)('₀' + 0)} = "); //inicio do passo a passo
                                ...
                                if (quoc != 0) //se o quociente for 0, o resto vai ser 0
                                {
                                    while (quoc != 0) //enquanto o quociente não for 0, continuar a divisão
                                    {
                                        ...
                                        ltx_resultado.Items.Add($"{quoc} / 2  = {quoc / 2}, Resto = {quoc % 2}"); //adicionando ao passo a passo
                                ...
                                ltx_resultado.Items.Add($"= ({resultadoString}){(char)('₀' + 2)}"); //final do passo a passo é o resultado
                            ...
                            case "Hexadecimal": //decimal -> hexa
                                    ...
                                    while (quoc != 0) //enquanto o quociente não for 0, continuar a divisão
                                    {
                                        switch (quoc % 16) //caso o quociente for maior que 9, inserir a letra correspondente em hexa
                                        {
                                            case 10:
                                                ...
                                                ltx_resultado.Items.Add($"{quoc} / 16 = {quoc / 16}, Resto = {quoc % 16} -> A"); //adicionando ao passo a passo
                                                break;

                                            case 11:
                                                resto = resto.Insert(0, "B"); //resto é o digito mais a direita, incrementando ao resto
                                                ltx_resultado.Items.Add($"{quoc} / 16 = {quoc / 16}, Resto = {quoc % 16} -> B"); //adicionando ao passo a passo
                                                break;

                                            case 12:
                                                resto = resto.Insert(0, "C"); //resto é o digito mais a direita, incrementando ao resto
                                                ltx_resultado.Items.Add($"{quoc} / 16 = {quoc / 16}, Resto = {quoc % 16} -> C"); //adicionando ao passo a passo
                                                break;

                                            case 13:
                                                resto = resto.Insert(0, "D"); //resto é o digito mais a direita, incrementando ao resto
                                                ltx_resultado.Items.Add($"{quoc} / 16 = {quoc / 16}, Resto = {quoc % 16} -> D"); //adicionando ao passo a passo
                                                break;

                                            case 14:
                                                resto = resto.Insert(0, "E"); //resto é o digito mais a direita, incrementando ao resto
                                                ltx_resultado.Items.Add($"{quoc} / 16 = {quoc / 16}, Resto = {quoc % 16} -> E"); //adicionando ao passo a passo
                                                break;

                                            case 15:
                                                resto = resto.Insert(0, "F"); //resto é o digito mais a direita, incrementando ao resto
                                                ltx_resultado.Items.Add($"{quoc} / 16 = {quoc / 16}, Resto = {quoc % 16} -> F"); //adicionando ao passo a passo
                                                break;

                                            default:
                                                resto = resto.Insert(0, (quoc % 16).ToString()); //resto é o digito mais a direita
                                                ltx_resultado.Items.Add($"{quoc} / 16 = {quoc / 16}, Resto = {quoc % 16}"); //adicionando ao passo a passo
                                                break;
                                        }
                                ...
                                ltx_resultado.Items.Add($"= ({resto}){(char)('₀' + 1)}{(char)('₀' + 6)}"); //final do passo a passo exibindo o resultado
                    ...
                    case "Binário": //base binária
                        ...
                        switch (rbt_baseFinal.Text) //base desejada para conversão
                        {
                            case "Decimal": //binário -> decimal
                                ...
                                ltx_resultado.Items.Add($"({binarioNormalizado}){(char)('₀' + 2)} = "); //inicio do passo a passo
                                ...
                                for (int i = 0; i < binario.Length; i++) //para cada bit do binário
                                {
                                    ...
                                    ltx_resultado.Items.Add($"{binario[i]}.2{ToSuperScript(binario.Length - 1 - i)} = {calcFor}"); //passo a passo demonstrando a operação acima, utilizando a função ToSuperScript para adicionar o char do número elevado
                                ...
                                ltx_resultado.Items.Add($"{soma} = ({resultadoInt}){(char)('₀' + 1)}{(char)('₀' + 0)}"); //final do passo a passo exibindo o resultado
                                ...
                                for (int i = 0; i < binario.Length; i += 4)
                                {
                                    ...
                                    if (sub != "0000") //se o binário for 0, não entra na conta
                                    {
                                        ...
                                        if (sub != binario) //se o binário passado tiver apenas 4 bits, remover do passo a passo a divisão do binário
                                            ltx_resultado.Items.Add($"({sub}){(char)('₀' + 2)} = ");
                                        ...
                                        for (int j = 0; j < sub.Length; j++) //para cada bit do binario dividido
                                        {
                                            ...
                                            ltx_resultado.Items.Add($"{sub[j]}.2{ToSuperScript(sub.Length - 1 - j)} = {calcFor}"); //inserindo no passo a passo a conta acima
                                        ...
                                        switch (num) //caso o resultado da conversão seja maior que 10, mostrar a letra correspondente em hexa no passo a passo
                                        {
                                            case 10:
                                                resultadoString += "A";
                                                ltx_resultado.Items.Add($"{soma} = ({num}){(char)('₀' + 1)}{(char)('₀' + 6)} -> (A){(char)('₀' + 1)}{(char)('₀' + 6)}"); //mostrando a letra convertida do binario dividido
                                                break;

                                            case 11:
                                                resultadoString += "B";
                                                ltx_resultado.Items.Add($"{soma} = ({num}){(char)('₀' + 1)}{(char)('₀' + 6)} -> (B){(char)('₀' + 1)}{(char)('₀' + 6)}"); //mostrando a letra convertida do binario dividido
                                                break;

                                            case 12:
                                                resultadoString += "C";
                                                ltx_resultado.Items.Add($"{soma} = ({num}){(char)('₀' + 1)}{(char)('₀' + 6)} -> (C){(char)('₀' + 1)}{(char)('₀' + 6)}"); //mostrando a letra convertida do binario dividido
                                                break;

                                            case 13:
                                                resultadoString += "D";
                                                ltx_resultado.Items.Add($"{soma} = ({num}){(char)('₀' + 1)}{(char)('₀' + 6)} -> (D){(char)('₀' + 1)}{(char)('₀' + 6)}"); //mostrando a letra convertida do binario dividido
                                                break;

                                            case 14:
                                                resultadoString += "E";
                                                ltx_resultado.Items.Add($"{soma} = ({num}){(char)('₀' + 1)}{(char)('₀' + 6)} -> (E){(char)('₀' + 1)}{(char)('₀' + 6)}"); //mostrando a letra convertida do binario dividido
                                                break;

                                            case 15:
                                                resultadoString += "F";
                                                ltx_resultado.Items.Add($"{soma} = ({num}){(char)('₀' + 1)}{(char)('₀' + 6)} -> (F){(char)('₀' + 1)}{(char)('₀' + 6)}"); //mostrando a letra convertida do binario dividido
                                                break;

                                            default:
                                                resultadoString += num.ToString(); //adicionando o número convertido ao resultado final
                                                ltx_resultado.Items.Add($"{soma} = ({num}){(char)('₀' + 1)}{(char)('₀' + 6)}"); //mostrando o numero convertido do binario dividido
                                                break;
                                        }
                                    }
                                    else
                                    {
                                        ltx_resultado.Items.Add($"({sub}){(char)('₀' + 2)} = (0){(char)('₀' + 1)}{(char)('₀' + 6)}"); //adicionando o número 0 ao passo a passo sem a realização da conta e ao resultado
                                        resultadoString += "0";
                                    }
                                }

                                ltx_resultado.Items.Add($"= ({resultadoString}){(char)('₀' + 1)}{(char)('₀' + 6)}"); //final do passo a passo com o resultado
                    ...
                    case "Hexadecimal": //base hexa
                        ...
                        switch (rbt_baseFinal.Text) //base desejada para conversão
                        {
                            case "Decimal": //hexa -> decimal
                                ...
                                ltx_resultado.Items.Add($"({hexa}){(char)('₀' + 1)}{(char)('₀' + 6)} ="); //inicio do passo a passo
                                ...
                                for (int i = 0; i < hexa.Length; i++) //para cada bit do hexadecimal
                                {
                                    switch (hexa[i]) //caso o bit seja uma letra, adicionar ao resultado o número correspondente
                                    {
                                        case 'A':
                                            ...
                                            ltx_resultado.Items.Add($"A.16{ToSuperScript(hexa.Length - 1 - i)} -> 10.16{ToSuperScript(hexa.Length - 1 - i)} = {calcFor}"); //passo a passo demonstrando a operação acima, utilizando a função ToSuperScript para adicionar o char do número elevado
                                        ...
                                        case 'B':
                                            ...
                                            ltx_resultado.Items.Add($"B.16{ToSuperScript(hexa.Length - 1 - i)} -> 11.16{ToSuperScript(hexa.Length - 1 - i)} = {calcFor}"); //passo a passo demonstrando a operação acima, utilizando a função ToSuperScript para adicionar o char do número elevado
                                            resultadoInt += calcFor; //adicionando ao resultado final a conta do bit atual do hexa
                                            break;

                                        case 'C':
                                            calcFor = 12 * (int)Math.Pow(16, hexa.Length - 1 - i); //resultado = bit vezes 16 elevado a posição do bit
                                            ltx_resultado.Items.Add($"C.16{ToSuperScript(hexa.Length - 1 - i)} -> 12.16{ToSuperScript(hexa.Length - 1 - i)} = {calcFor}"); //passo a passo demonstrando a operação acima, utilizando a função ToSuperScript para adicionar o char do número elevado
                                            resultadoInt += calcFor; //adicionando ao resultado final a conta do bit atual do hexa
                                            break;

                                        case 'D':
                                            calcFor = 13 * (int)Math.Pow(16, hexa.Length - 1 - i); //resultado = bit vezes 16 elevado a posição do bit
                                            ltx_resultado.Items.Add($"D.16{ToSuperScript(hexa.Length - 1 - i)} -> 13.16{ToSuperScript(hexa.Length - 1 - i)} = {calcFor}"); //passo a passo demonstrando a operação acima, utilizando a função ToSuperScript para adicionar o char do número elevado
                                            resultadoInt += calcFor; //adicionando ao resultado final a conta do bit atual do hexa
                                            break;

                                        case 'E':
                                            calcFor = 14 * (int)Math.Pow(16, hexa.Length - 1 - i); //resultado = bit vezes 16 elevado a posição do bit
                                            ltx_resultado.Items.Add($"E.16{ToSuperScript(hexa.Length - 1 - i)} -> 14.16{ToSuperScript(hexa.Length - 1 - i)} = {calcFor}"); //passo a passo demonstrando a operação acima, utilizando a função ToSuperScript para adicionar o char do número elevado
                                            resultadoInt += calcFor; //adicionando ao resultado final a conta do bit atual do hexa
                                            break;

                                        case 'F':
                                            calcFor = 15 * (int)Math.Pow(16, hexa.Length - 1 - i); //resultado = bit vezes 16 elevado a posição do bit
                                            ltx_resultado.Items.Add($"F.16{ToSuperScript(hexa.Length - 1 - i)} -> 15.16{ToSuperScript(hexa.Length - 1 - i)} = {calcFor}"); //passo a passo demonstrando a operação acima, utilizando a função ToSuperScript para adicionar o char do número elevado
                                            resultadoInt += calcFor; //adicionando ao resultado final a conta do bit atual do hexa
                                            break;
                                        ...
                                        default:
                                            ...
                                            ltx_resultado.Items.Add($"{hexa[i]}.16{ToSuperScript(hexa.Length - 1 - i)} = {calcFor}"); //passo a passo demonstrando a operação acima, utilizando a função ToSuperScript para adicionar o char do número elevado
                                            resultadoInt += calcFor; //adicionando ao resultado final a conta do bit atual do hexa
                                            break;
                                    }
                                ...
                                ltx_resultado.Items.Add($"{soma} = ({resultadoInt}){(char)('₀' + 1)}{(char)('₀' + 0)}"); //fim do passo a passo
                            ...
                            case "Binário": //hexa -> binário
                                ...
                                for (int i = 0; i < hexa.Length; i++) //para cada bit em hexadecimal
                                {
                                    ...
                                    switch (hexa[i]) //caso o bit em hexa seja uma letra, resultado sera o binario correspondente a letra
                                    {
                                        case 'A':
                                            ...
                                            quoc = 10;
                                            ltx_resultado.Items.Add($"({hexa[i]}){(char)('₀' + 1)}{(char)('₀' + 6)} -> 10 ="); //mostrando no passo a passo a conversão de cada bit para binario
                                            break;

                                        case 'B':
                                            resultadoString += "1011"; //11 em binario
                                            quoc = 11;
                                            ltx_resultado.Items.Add($"({hexa[i]}){(char)('₀' + 1)}{(char)('₀' + 6)} -> 11 ="); //mostrando no passo a passo a conversão de cada bit para binario
                                            break;

                                        case 'C':
                                            resultadoString += "1100"; //12 em binario
                                            quoc = 12;
                                            ltx_resultado.Items.Add($"({hexa[i]}){(char)('₀' + 1)}{(char)('₀' + 6)} -> 12 ="); //mostrando no passo a passo a conversão de cada bit para binario
                                            break;

                                        case 'D':
                                            resultadoString += "1101"; //13 em binario
                                            quoc = 13;
                                            ltx_resultado.Items.Add($"({hexa[i]}){(char)('₀' + 1)}{(char)('₀' + 6)} -> 13 ="); //mostrando no passo a passo a conversão de cada bit para binario
                                            break;

                                        case 'E':
                                            resultadoString += "1110"; //14 em binario
                                            quoc = 14;
                                            ltx_resultado.Items.Add($"({hexa[i]}){(char)('₀' + 1)}{(char)('₀' + 6)} -> 14 ="); //mostrando no passo a passo a conversão de cada bit para binario
                                            break;

                                        case 'F':
                                            resultadoString += "1111"; //15 em binario
                                            quoc = 15;
                                            ltx_resultado.Items.Add($"({hexa[i]}){(char)('₀' + 1)}{(char)('₀' + 6)} -> 15 ="); //mostrando no passo a passo a conversão de cada bit para binario
                                            break;
                                        ...
                                        default:
                                            ...
                                            ltx_resultado.Items.Add($"({hexa[i]}){(char)('₀' + 1)}{(char)('₀' + 6)} ="); //mostrando no passo a passo a conversão de cada bit para binario
                                            break;
                                    }
                                    ...
                                    ltx_resultado.Items.Add($"= ({resto}){(char)('₀' + 2)}"); //final do passo a passo exibindo o resultado do bit em hexa convertido
                                }
                                ...
                                ltx_resultado.Items.Add($"= ({binarioNorm}){(char)('₀' + 2)}"); //fim do passo a passo exibindo o resultado
